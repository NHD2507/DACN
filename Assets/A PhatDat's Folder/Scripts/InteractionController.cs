...
{
    [SerializeField] private float interactionRange = 3f; // Phạm vi tương tác
    [SerializeField] private LayerMask interactionLayer; // Layer tương tác
    ...
    private void PerformInteraction()
    {
        ...
        if (Physics.Raycast(ray, out RaycastHit hit, interactionRange, interactionLayer))
        {
            ...
            if (interactable != null)
            {
                interactable.Interact(); // Gọi phương thức Interact
            }
        }
    }
}
